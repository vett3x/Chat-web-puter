...
export async function provisionApp(data: AppProvisioningData) {
  ...
  try {
    ...
    await appendToServerProvisioningLog(serverIdForLog, `[App Provisioning] Buscando servidor listo disponible en el sistema...\n`);
    ...
    if (serverError || !serverData) {
      throw new Error('No hay servidores listos disponibles en el sistema. Asegúrate de haber añadido y aprovisionado un servidor en el Panel de Administración.');
    }
    server = serverData;
