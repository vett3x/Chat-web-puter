      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li><Link href="/legal/privacy-policy" className="text-sm text-white/60 hover:text-white">Privacidad</Link></li>
              <li><Link href="/legal/terms-of-service" className="text-sm text-white/60 hover:text-white">Términos</Link></li>
            </ul>
          </div>
        </div>
