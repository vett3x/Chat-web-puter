            ...
            <Dialog open={isProvisionDialogOpen} onOpenChange={setIsProvisionDialogOpen}>
              ...
              <DialogContent className="sm:max-w-[600px]">
                <DialogHeader>
                  ...
                  <DialogDescriptionComponent>Instala y configura PostgreSQL de forma segura en un servidor Ubuntu limpio.</DialogDescriptionComponent>
                </DialogHeader>
                <Form {...provisionForm}>
              ...
              <DialogContent className="sm:max-w-[525px]">
                <DialogHeader>
                  ...
                  <DialogDescriptionComponent>
                    {editingConfig ? 'Actualiza los detalles de tu conexión a la base de datos.' : 'Añade una nueva conexión a una base de datos PostgreSQL existente.'}
                  </DialogDescriptionComponent>
                </DialogHeader>
                <Form {...configForm}>
      ...
      <Dialog open={!!viewingLogConfig} onOpenChange={(open) => !open && setViewingLogConfig(null)}>
        <DialogContent className="sm:max-w-[80vw] h-[80vh] flex flex-col">
          <DialogHeader>
            ...
            <DialogDescriptionComponent>Mostrando la salida del script de instalación.</DialogDescriptionComponent>
          </DialogHeader>
