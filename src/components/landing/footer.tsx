...
export const LandingFooter = React.forwardRef<HTMLElement>((props, ref) => {
  return (
    <footer ref={ref} className="w-full bg-black/30 border-t border-white/10 mt-24 z-10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li><Link href="#" className="text-sm text-white/60 hover:text-white">Privacidad</Link></li>
              <li><Link href="#" className="text-sm text-white/60 hover:text-white">Términos</Link></li>
            </ul>
          </div>
        </div>
